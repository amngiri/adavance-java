...
public class EmployeeController {
	...
	//   api/employess/1234
	@PostMapping
	public Employee addEmpDetails(@RequestBody Employee e) // de-serial (un marshalling)
	{
	...
	// resource) : PUT
	@PutMapping
	public Employee updateEmpDetails(@RequestBody Employee e) // de-serial (un marshalling)
	{
