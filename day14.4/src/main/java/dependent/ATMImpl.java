...
public class ATMImpl implements ATM {
	...
	//factory method : public static ATMImpl myFactory(.......) : args => dependencies
	//Factory method based D.I : method wil be invoked by SC
	public static ATMImpl myFactory(Transport t)
	{
		System.out.println("in factory "+t);
		return new ATMImpl(t);//Prog has to manage creation of dependent bean n passing the dependency
	}
